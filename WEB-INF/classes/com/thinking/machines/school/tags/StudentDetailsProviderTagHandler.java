...
public class StudentDetailsProviderTagHandler extends BodyTagSupport
{
...
public StudentDetailsProviderTagHandler()
{
reset();
}
...
{
sqlStatement=sqlStatement+" where name='"+studentName+"'";
}
